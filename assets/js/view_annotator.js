...
(function() {
  ...
  //constants
  var IMAGE_DELETE =  'https://cm-kls-content.s3.amazonaws.com/DESEN_WEBAULA/LDD_APRIMORAMENTO/img/annotator/icono_eliminar.png',
  IMAGE_DELETE_OVER = 'https://cm-kls-content.s3.amazonaws.com/DESEN_WEBAULA/LDD_APRIMORAMENTO/img/annotator/papelera_over.png',
  SHARED_ICON = 'https://cm-kls-content.s3.amazonaws.com/DESEN_WEBAULA/LDD_APRIMORAMENTO/img/annotator/shared-icon.png';
  ...
  Annotator.Plugin.AnnotatorViewer = (function(_super) {
    ...
    */
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {  
      ...
      var delete_icon = "<img src=\""+IMAGE_DELETE+"\" class=\"annotator-viewer-delete\" title=\""+ i18n_dict.Delete +"\" style=\" float:right;margin-top:3px;;margin-left:3px\"/><img src=\"https://cm-kls-content.s3.amazonaws.com/DESEN_WEBAULA/LDD_APRIMORAMENTO/img/annotator/edit-icon.png\"   class=\"annotator-viewer-edit\" title=\"Editar\" style=\"float:right;margin-top:3px\"/>";
      ...
      annotation_layer += '<div class="anotador_text">'+  textAnnotation  + '</div></div><div class="annotator-marginviewer-date">'+ $.format.date(annotation.data_creacio, "dd/MM/yyyy HH:mm:ss") + '</div><div class="annotator-marginviewer-quote">'+ annotation.quote + '</div><div class="annotator-marginviewer-footer"><span>Ver comentário</span>'+shared_annotation+delete_icon+'</div>';
    ...
    AnnotatorViewer.prototype.createAnnotationPanel = function(annotation) {     
      var checboxes = 'Anotações';

      var annotation_layer =  '<div  class="annotations-list-uoc" style="background-color:#ddd;"><div id="annotations-panel"><span class="rotate" title="'+ i18n_dict.view_annotations +' '+ i18n_dict.pdf_resum +'" style="padding:10px;background-color:#ddd;position: absolute; top:10em;left: -150px; width: 250px; height: auto;cursor:pointer">'+ i18n_dict.view_annotations +'<span class="label-counter" style="padding:0.2em 0.3em;float:right" id="count-anotations">0</span></span></div><div id="anotacions-uoc-panel" style="height:80%"><ul class="container-anotacions"><li class="filter-panel">'+checboxes+'</li></ul></div></div>';
